...
-- إدخال بيانات في جدول الشركات (Firma)
...
-- إدخال بيانات في جدول الموظفين الداخليين (Mitarbeiter)
...
-- إدخال بيانات في جدول الموظفين الخارجيين (Externe Mitarbeiter)
...
-- إدخال بيانات في جدول العملاء (Kunden)
...
-- إدخال بيانات في جدول العلاقة بين الموظفين والعملاء (Mitarbeiter_Kunden)
